...
const translations = {
  de: {
    ...
    'form.titlePlaceholder': 'Kurztitel unter dem Sie ihr Projekt einreichen/eingereicht haben',
    ...
    'upload.failed.desc': 'Der Upload konnte nicht abgeschlossen werden. Bitte versuchen Sie es erneut oder informieren Sie den Administrator.',
    'upload.file': 'Datei',
    ...
    'confirmation.step1': 'Überprüfen Sie auch Ihren Spam-Ordner auf die Bestätigungs-E-Mail.',
    'confirmation.step2': 'Bei Rückfragen werden Sie per E-Mail kontaktiert',
    'confirmation.step3': 'Nur bei Neueinreichungen, sobald die Unterlagen vollständig sind: Wenn Sie innerhalb einer 14-Tages-Frist keine Rückmeldung von uns bekommen, gilt Ihr Projekt als automatisch freigegeben und Sie können starten. (Dies gilt nicht für Ausnahmen vom Standard gemäß SOP).',
    'confirmation.step4': 'Bei Bearbeitungen: Wurde Ihre Studie gestoppt, müssen Sie auf die Freigabe durch den Datenschutz per E-Mail warten.',
  ...
  en: {
    ...
    'existingProject.warning': 'This option only applies to research projects that have already been submitted in accordance with the new data protection process (valid since May 2025). You can upload missing documents and revisions here if, for example, the data protection team has any questions or requests, or if something needs to be submitted at a later date. If you want to make content changes to already approved projects (amendments) (started before or after the new data protection process), please contact the data protection team by email. If you want to resubmit projects that you had already submitted before the new data protection process, please select "Submit new project" on the home page.',
    ...
    'existingProject.templates': 'Here you can find templates for resubmissions. Unfortunately, the documents are currently only available in German.',
    ...
    'form.legalConfirmation': 'Document: Commitment to legally compliant data use ("Verpflichtung zur rechtskonformen Datennutzung")',
    
    // Links
    'link.moodle': 'Moodle Course',
    'link.sop': 'SOP (Standard Operating Procedure)',
    'link.research': 'Roxtra-Folder Research',
    ...
    'upload.failed.desc': 'The upload could not be completed. Please try again or contact the administrator.',
    'upload.file': 'file',
    'upload.files': 'files',
    ...
    'confirmation.step1': 'Please also check your spam folder for the confirmation email.',
    'confirmation.step2': 'You will be contacted by email if there are any questions',
    'confirmation.step3': 'For new submissions only, once the documents are complete: If you do not hear from us within 14 days, your project is automatically approved and you can start. (This does not apply to exceptions to the standard according to SOP).',
    'confirmation.step4': 'If editing an existing project: If your study has been stopped, you must wait for approval from data protection by email.',
